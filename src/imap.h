...
void init_curl(const char *login, const char *passwd, const char *server, const char *resolve = nullptr);
...
int imap_fetch_size(std::string mailbox, unsigned int uid, imap_handler handler = nullptr, void* pointer = nullptr);
